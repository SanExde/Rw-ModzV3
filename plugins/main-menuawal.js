...
'thumbnail':await(await fetch('https://telegra.ph/file/cece2bf3861912ef1a00d.jpg')).buffer(),
'sourceUrl':sgc}},
'caption':kata,
'footer':botdate,
'buttons':[
{'buttonId':'.? all','buttonText':{'displayText':'ALL MENU'},'type':1},
{'buttonId':'.tesm','buttonText':{'displayText':'LIST MENU'},'type':1}
],
'headerType':6}
