...
conn.sendButtonDoc(m.chat, '▷BOT STATUS◁', sts, 'OWNER', '.owner', m, { contextInfo: { externalAdReply: { showAdAttribution: false,
    mediaUrl: 'https//wa.me/6282114680993?text=ʜᴀʟᴏ+ᴏᴡɴᴇʀ',
    mediaType: 2, 
    description: 'wa.me/6282114680993?text=ʜᴀʟᴏ+ᴏᴡɴᴇʀ',
    title: "INI INSTAGRAM GW!",
    body: wm,
    thumbnail: fs.readFileSync('./thumbnail.jpg'),
    sourceUrl: 'https://Instagram com/san.xd12_'
     }}
  })
